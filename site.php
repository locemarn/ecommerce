...
$app->post("/register", function(){
	...
	if(User::checkLoginExist($_POST['email']) === true){
		...
		User::setErrorRegister("E-mail em uso. Digite outro e-mail.");
		header("Location: /login");
		exit;
...
//ROTAS DO ESQUECI A SENHA DO USUÁRIO
...
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: lojavirtualmns@gmail.com";
